...
namespace Classifieds.ListingCommentsAPI.Tests
{
    ...
    public class ListingCommentsRepositoryTest
    {
        ...
        [TestMethod]
        // <summary>
        /// test positive scenario for Get listing comments  
        /// </summary>
        public void Repo_CreateListingCommentTest()
        {
            //Arrange
            ListingComment dataObject = GetListingCommentObject("5873490a48bd151ef5d67a29");
        ...
        public void GetAllCategory_Repo_GeAllListingComments_Invalid_OR_Null_Category()
        {
        ...
        /// <summary>
        /// test positive scenario for Get ListingComments By Id 
        /// </summary>
        [TestMethod]
